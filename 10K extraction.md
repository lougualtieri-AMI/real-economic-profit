...
8. "Maintenance CapEx" — Only if separately disclosed in MD&A; otherwise return 0
9. "Restructuring Charges" — From operating expenses or cash flow; 0 if none
10. "Inventory Change" — Positive = decrease (cash freed), Negative = increase (cash trapped); 0 if N/A
11. "Receivables Change" — Positive = decrease (cash collected), Negative = increase (cash not collected)
12. "Interest Paid" — From Supplemental Disclosures at bottom of Cash Flow Statement; null if not found
13. "Income Tax Paid" — From Supplemental Disclosures at bottom of Cash Flow Statement; null if not found

OPTIONAL INCOME STATEMENT (for trend analysis):

14. "Revenue" — Total revenue / net revenue for the fiscal year; null if not in filing
15. "Net Income" — Net income attributable to common shareholders; null if not in filing

BALANCE SHEET ITEMS (from latest available — 10-Q if provided, otherwise 10-K year-end):

16. "Total Debt" — Sum: commercial paper + current term debt + non-current term debt
17. "Cash & Equivalents" — Cash and cash equivalents
18. "Short-Term Investments" — Current marketable securities
19. "Non-Current Marketable Securities" — Liquid bond portfolios only; EXCLUDE illiquid strategic/private equity investments; 0 if none
20. "Diluted Shares Outstanding" — Weighted-average diluted from EPS calculation
21. "Total Shareholders Equity" — Total stockholders'/shareholders' equity from balance sheet
22. "Total Assets" — Total assets from balance sheet
23. "Goodwill" — Goodwill from balance sheet; 0 if none
24. "Intangible Assets" — Net intangible assets (excluding goodwill) from balance sheet; 0 if none. If combined with goodwill on the balance sheet, check the Notes for the breakout.
```
...
### Goodwill & Intangible Assets (New)
...
If you've already extracted data and need to add Goodwill and Intangible Assets, use the **Backfill Prompt** (separate document) in your existing Gemini chats — no need to re-upload the 10-K.
