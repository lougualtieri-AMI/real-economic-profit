...
REPA is released under the **PolyForm Noncommercial License 1.0.0** — free to use,
study, and share for personal, academic, and other noncommercial purposes. See the
`LICENSE` file for the full terms.

**Commercial use requires written permission first.** That includes internal
deployment or use at a company or financial firm, using it with clients, and
including it in anything you charge for. The source is published openly so the
methods can be inspected and checked — being able to read it is not permission to
use it commercially.

For commercial licensing, contact **Louis Gualtieri** at **lougualtieri@gmail.com**
(please put "REPA" in the subject line).
...
| File | Purpose |
| --- | --- |
| `index.html` | The complete app — single file, no dependencies (v5.1.30) |
| `LICENSE` | PolyForm Noncommercial License 1.0.0 — the terms of use |
| `README.md` | This file |
